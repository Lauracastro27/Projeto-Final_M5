...
function CadastroPage() {
  ...
  const handleSubmit = async (e) =>{
   ...
   await cadastro(email, senha, idade, nome, endereco, favorito);//Integracao com o contexto e api
  }
      ...
      <div id="cadastro">
        <form method="post" onSubmit={handleSubmit}> 
          ...
          <p> 
            ...
            <input id="comida" name="comida" required="required" type="text" placeholder="Pizza"
            value={favorito} 
